app.controller('doimatkhau', function ($scope, $http) {
    ...
    $scope.luu = function () {
        ...
        $http
            .post('http://localhost:8080/api/changePass/customer/changePass', data, { headers })
    ...
    $scope.quayLai = function () {
        window.location.href = '#!/thong-tin-khach-hang';
    };
});
